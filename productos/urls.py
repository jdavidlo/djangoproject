...
urlpatterns = [
    ...
    path('borrar/<int:id>', views.catdelete, name='catdelete'),
    path('crearCategoria/', views.crearcat, name='crearcat'),
    path('editarCategoria/<int:id>', views.catedit, name='catedit'),
